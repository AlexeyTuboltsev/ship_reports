...
SettingsDialog::SettingsDialog(wxWindow *parent, shipobs_pi *plugin)
    : wxDialog(parent, wxID_ANY, _("Ship Obs Settings"),
    ...
    serverSizer->Add(new wxStaticText(this, wxID_ANY, _("Server URL:")),
                     0, wxALL, 2);
    ...
    triggers.Add(_("Both"));
    m_info_trigger = new wxRadioBox(this, wxID_ANY, _("Station info"),
                                    wxDefaultPosition, wxDefaultSize,
